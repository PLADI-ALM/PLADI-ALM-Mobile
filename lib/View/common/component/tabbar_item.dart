...
final adminTabBarIcons = [
  ...
  BottomNavigationBarItem(
      icon: SvgPicture.asset("asset/image/tab_icon/admin_unselected.svg", width: iconWidth, height: iconHeight),
      activeIcon: SvgPicture.asset("asset/image/tab_icon/admin_selected.svg", width: iconWidth, height: iconHeight),
      label: '관리자'
  ),
];